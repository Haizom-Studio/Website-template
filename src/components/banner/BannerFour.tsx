...
const BannerFour = ({title, description, subtitle} : BannerFourProps) => {
    return (
        <div className="banner banner-style-4">
            <div className="container">
                <div className="banner-content">
                    ...
                    <p>{description}</p>
                    <div>
                        <Link href={process.env.PUBLIC_URL + "/project-grid-one"} className="axil-btn btn-fill-primary btn-large">View Showcase</Link>
                    </div>
                </div>
