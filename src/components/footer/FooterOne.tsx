                ...
                <div className="footer-top">
                    <div className="footer-social-link">
                        <ul className="list-unstyled">
                            ...
                            <li><Link href="https://twitter.com/"><FaXTwitter /></Link></li>
                            ...
                            <li><Link href="https://www.tiktok.com/en/"><FaTiktok /></Link></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-3">
                                    <div className="footer-widget">
                                        ...
                                        <div className="footer-menu-link">
                                            <ul className="list-unstyled">
                                                <li><Link href={process.env.PUBLIC_URL + "/blog-grid"}>Blog</Link></li>
                                                <li> <Link href={process.env.PUBLIC_URL + "/case-study"}>Case Studies</Link></li>
                                                <li><Link href={process.env.PUBLIC_URL + "/project-grid-one"}>Portfolio</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-sm-3">
                                    <div className="footer-widget">
                                        ...
                                        <div className="footer-menu-link">
                                            <ul className="list-unstyled">
                                                <li><Link href={process.env.PUBLIC_URL + "/contact"}>Contact</Link></li>
